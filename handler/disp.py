...
class Disp(bcolors):
    ...
    def green(self, text, *args):
        print(self.OK + str(text) + ' ' + ' '.join([str(arg) for arg in args]) + self.RESET)
    
    def yellow(self, text, *args):
        print(self.WARNING + str(text) + ' ' + ' '.join([str(arg) for arg in args]) + self.RESET)

    def red(self, text, *args):
        print(self.FAIL + str(text) + ' ' + ' '.join([str(arg) for arg in args]) + self.RESET)

    def blue(self, text, *args):
        print(self.BLUE + str(text) + ' ' + ' '.join([str(arg) for arg in args]) + self.RESET)

    def purple(self, text, *args):
        print(self.PURPLE + str(text) + ' ' + ' '.join([str(arg) for arg in args]) + self.RESET)
