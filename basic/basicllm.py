...
class BasicLLM():
    ...
    def once(self, 
        ...
        response, input_len, output_len = model_dict['llm'].chat(
            messages,
            model_dict['tokenizer'],
            temperature=temperature,
            device=model_dict['flex_device'],
            verbose=verbose,
            max_new_tokens=max_new_tokens
        )
        if self.params.get('show'):
            disp.purple(f'LLM input and output word counts (estimated): {input_len}, {output_len}')
